      ...
      https.get(Object.assign({}, API, { path }), res => {
        ...
        res.on('end', () => {
          ...
          if (shelters.length > 0) {
            ...
            const updatedDuration = (new Date() - new Date(shelters[0].updatedAt)) / (1000 * 60 * 60);
            ...
            apiaiResp.displayText =
              ...
              Phone: ${shelters[0].phone}

              As of ${updatedDuration} hours ago, they are still accepting newcomers.
              `;
